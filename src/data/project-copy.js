export const projectCopy = {
  ...
  "cross-border-ecommerce-operations": {
    ...
    context: "Cross-border e-commerce depends on clarity. Customers need accurate information and reliable updates, while suppliers and logistics partners need clear order details, timing and follow-up across different markets and expectations.",
    role: "I supported marketplace operations, order follow-up, product-listing improvements, customer and supplier communication, after-sales support and social-media-led customer development.",
    approach: "I coordinated fulfilment conversations in English and Cantonese, improved how products were presented online and supported visits to customers, suppliers and factories across several markets.",
    outcome: "The project strengthened my understanding of how operations, customer relationships and product information work together. It shows the practical value of calm, precise communication across the complete shopping journey.",
    visuals: "The current visual set centres on supplier and factory visits. Redacted listings, fulfilment flows and logistics touchpoints remain to be added when permissions and evidence are confirmed.",
  ...
  "photography-visual-storytelling": {
    ...
    context: "The archive brings together fashion and styling, objects and craft, travel, everyday life and observations of how people move through spaces.",
    role: "I work as photographer and visual storyteller, selecting, sequencing and pairing images to build a quiet editorial rhythm.",
    approach: "The work draws on editorial photography, material culture and everyday observation. I look closely at atmosphere, craftsmanship and the emotional signals carried by images and objects.",
